...
void UPickupNotificationWidget::InitializeNotification(UItemDataBase* ItemData, int32 GainedAmount, int32 NewTotalCount, float InLifetime, float InFadeOutDuration)
{
	if (!ItemData)
	{
		return;
